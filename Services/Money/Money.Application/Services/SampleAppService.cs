...
namespace Sample.Application.Services
{
    public class SampleAppService : ISampleAppService
    {
        ...
        public void Update(SampleVM moneyViewModel)
        {
            _repository.Update(_mapper.Map<SampleInfo>(moneyViewModel));
        }

        public async Task<HasBodyResponse<SampleResponse>> Login(SampleVM moneyViewModel)
        {
            return await _bus.SendCommand(new LoginCommand(_mapper.Map<SampleInfo>(moneyViewModel)));
        }
    }
}
