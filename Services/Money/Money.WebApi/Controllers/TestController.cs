...
namespace Money.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformMoney { get; set; }
        ...
        public TestInfo(int id, string money, string name, int sex, string head)
        {
            Id = id;
            PlatformMoney = money;
            UserName = name;
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("MoneyInfo");
        }
