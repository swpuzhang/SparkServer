...
namespace Dummy.Domain.Manager
{
    ...
    public class MatchingManager
    {
        ...
        private IDummyRedisRepository _redis;
        ...
        public async Task<BodyResponse<DummyMatchingResponseInfo>> MatchingRoom(long id, long blind, string curRoomId)
        {
            ...
            using (var locker = _redis.Locker(KeyGenHelper.GenUserKey(id, UserRoomInfo.className)))
            {
                ...
                {
                    return new BodyResponse<DummyMatchingResponseInfo>(StatusCodeDefines.IsMatching, null, null);
                }
                ...
                try
                {
                    ...
                    if (roomResponse.StatusCode == StatusCodeDefines.Success)
                    {
                        ...
                        return new BodyResponse<DummyMatchingResponseInfo>(StatusCodeDefines.Success, null,
                            new DummyMatchingResponseInfo(id, roomInfo.RoomId, roomInfo.Blind, roomInfo.GameKey));
                    }
                    else
                    {
                        ...
                        return new BodyResponse<DummyMatchingResponseInfo>(roomResponse.StatusCode, roomResponse.ErrorInfos, null);
                    }
                }
                ...
                catch
                {
                    ...
                    return new BodyResponse<DummyMatchingResponseInfo>(StatusCodeDefines.BusError, null, null);
                }
            }
        }
