...
namespace Dummy.Game.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformDummy { get; set; }
        ...
        public TestInfo(int id, string dummy, string name, int sex, string head)
        {
            Id = id;
            PlatformDummy = dummy;
            UserName = name;
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("DummyInfo");
        }
