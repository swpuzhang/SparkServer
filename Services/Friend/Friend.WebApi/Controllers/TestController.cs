...
namespace Friend.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformFriend { get; set; }
        ...
        public TestInfo(int id, string friend, string name, int sex, string head)
        {
            Id = id;
            PlatformFriend = friend;
            UserName = name;
            Sex = sex;
            HeadUrl = head;
        }
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("FriendInfo");
        }
