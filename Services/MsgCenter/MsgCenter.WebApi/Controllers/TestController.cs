...
namespace MsgCenter.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformMsgCenter { get; set; }
        ...
        public TestInfo(int id, string msgcenter, string name, int sex, string head)
        {
            Id = id;
            PlatformMsgCenter = msgcenter;
            UserName = name;
            Sex = sex;
            HeadUrl = head;
        }
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("MsgCenterInfo");
        }
