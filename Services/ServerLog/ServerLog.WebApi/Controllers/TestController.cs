...
namespace ServerLog.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformServerLog { get; set; }
        ...
        public TestInfo(int id, string serverlog, string name, int sex, string head)
        {
            Id = id;
            PlatformServerLog = serverlog;
            UserName = name;
            Sex = sex;
            HeadUrl = head;
        }
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("ServerLogInfo");
        }
