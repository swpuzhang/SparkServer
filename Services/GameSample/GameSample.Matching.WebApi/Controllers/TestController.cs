...
namespace GameSample.Matching.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformGameSample { get; set; }
        ...
        public TestInfo(int id, string gamesample, string name, int sex, string head)
        {
            Id = id;
            PlatformGameSample = gamesample;
            UserName = name;
            Sex = sex;
            HeadUrl = head;
        }
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("GameSampleInfo");
        }
