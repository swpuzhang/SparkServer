...
namespace UploadFile.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformUploadFile { get; set; }
        ...
        public TestInfo(int id, string uploadfile, string name, int sex, string head)
        {
            Id = id;
            PlatformUploadFile = uploadfile;
            UserName = name;
            Sex = sex;
            HeadUrl = head;
        }
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("UploadFileInfo");
        }
