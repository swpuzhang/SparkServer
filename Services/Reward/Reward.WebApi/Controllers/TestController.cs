...
namespace Reward.WebApi.Controllers
{
    ...
    public class TestInfo 
    {
        ...
        public string PlatformReward { get; set; }
        ...
        public TestInfo(int id, string reward, string name, int sex, string head)
        {
            Id = id;
    ...
    public class TestController : ControllerBase
    {
        ...
        public TestController(IMongoSettings settings)
        {
            ...
            _infos = database.GetCollection<TestInfo>("RewardInfo");
        }
