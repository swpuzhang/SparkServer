...
namespace Account.Domain.Manager
{
    public class WSHostManager
    {
        ...
        public void OnNotifyHostInfo(string host, int userCount)
        {
            lock(_syncLock)
            {
                DateTime tnow = DateTime.Now;
        ...
        private SortedSet<HostInfo> _hostInfos = new SortedSet<HostInfo>();
        private SortedSet<HostInfoSortByAlive> _hostAliveInfos = new SortedSet<HostInfoSortByAlive>();
        private Dictionary<string, KeyValuePair<HostInfo, HostInfoSortByAlive>> _allHost = 
